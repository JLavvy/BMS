    ...
    <div class="row justify-content-center">
      <div class="col-md-9 col-lg-5">
        <div class="card shadow-sm">
          <div class="card-body">
            <h1 class="card-title text-center mb-5">Add Student</h1>
            ...
            <form method="post">
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  ...
                  <input type="tel" class="form-control" id="phone" name="Student_phone_number" placeholder="Enter Phone Number" required>
                </div>
              </div>
              ...
              <button type="submit" id="submit" class="btn btn-primary w-100 mb-3"><i class="fas fa-user-plus me-2"></i> Add Student
              </button>
